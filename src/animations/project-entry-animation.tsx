  ...
  return (
    ...
    >
      <div className="projects-entry-overlay absolute inset-0 flex items-center justify-center bg-black pointer-events-auto">
        <p className="projects-entry-text text-5xl md:text-7xl font-bold text-white font-bricolage-grotesque text-center px-4">
          {projectName}
        </p>
      </div>
    </div>
...
export default ProjectEntryAnimation;
