    ...
    >
      <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-6 items-center relative z-10">
        ...
        <div className="md:col-span-1 hidden md:block">
           <span className="text-sm font-medium text-gray-400 group-hover:text-[#008366] transition-colors duration-300">
            {project.year || "2024"}
          </span>
        </div>
        ...
        <div className="md:col-span-4 flex justify-end items-center">
            <div className="flex flex-wrap justify-end gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 md:translate-x-4 md:group-hover:translate-x-0 transition-all duration-500">
        ...
        <div className="md:col-span-1 flex justify-end">
            <ArrowUpRight className="size-6 md:size-8 text-gray-300 group-hover:text-[#008366] group-hover:rotate-45 transition-all duration-300" />
        </div>
      </div>
