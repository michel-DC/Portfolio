...
export function HeroSection() {
  return (
    <Section className="w-full min-h-[280px] flex flex-col items-start justify-center pt-10 pb-10 px-4 sm:px-8">
      ...
      <div className="sm:hidden flex flex-col w-full items-start mt-2">
        ...
        <div className="flex flex-wrap justify-start gap-2 w-full">
          ...
          >
            <Link href="mailto:micheldjoumessi.contact@gmail.com" target="_blank" rel="noopener noreferrer">
              <Mail className="size-3.5 text-black dark:text-foreground" /> Gmail
            </Link>
          </Button>
        </div>
      </div>
